...
class RGBPicker extends StatefulWidget {
  RGBPicker(
      {@required this.color, this.onColor, this.dynamicBackground: false});
...
class RGBPickerState extends State<RGBPicker> {
  ...
  Widget build(BuildContext context) {
    ...
    final bgColor = widget.dynamicBackground
        ? Color.fromRGBO(shade50.r, shade50.g, shade50.b, 1.0)
        : Colors.white;
